  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <a class="navbar-brand" href="urenregistratie.php"><img src='common/img/logo.png' style='height: 45px; margin-top: -13px;'></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <!--<ul class="nav navbar-nav">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li><a class="navbar-brand" href="urenregistratie.php"><img src='common/img/exit.png' style='height: 45px; margin-right: -15px; margin-top: -13px;'></a></li>
        </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>