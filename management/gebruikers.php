...
<td colspan="3" valign="top" class='tabbed-content-container ui-corner-all'>
    ...
    <div class="registreren" style="display: none">
        <form id="management_register_user" method="post" role="login">
            ...
            <input type="password" name="password" class="form-control input-lg" autocomplete="off" id="password"
                   placeholder="Wachtwoord"/>
            <input type="password" name="repassword" class="form-control input-lg" autocomplete="off" id="password"
